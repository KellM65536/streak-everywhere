...
![Pictogram of a flaming person running in a white circle. Top-level domains and other parts of urls follow them.](assets/man_running_pictogram_circled.png)
...
![Example of the popup: a white box displaying a label for "google.com", a half-full red bar indicating how many days in the week the streak has gone for, a large number to the left indicating the days of the streak (18), and a large number to right (with the backdrop of a flame) indicating the weeks of the streak (2).](assets/streak_example.png)
